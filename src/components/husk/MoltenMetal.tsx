/**
 * MoltenMetal: a full-viewport animated caustic filament effect rendered on a
 * WebGL 2 quad via ogl. Pauses automatically when scrolled offscreen or when
 * the tab is hidden. Unmounts cleanly.
 *
 * Ported from reactbits.dev/backgrounds/MoltenMetal, tuned for the Husk brand
 * palette (deep green → mint → white).
 */
...
const ctxMap = new WeakMap<HTMLElement, MoltenMetalRef>();
...
export type MoltenMetalProps = {
  ...
  readonly mouseInteraction?: boolean;
